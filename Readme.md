...
Мы предлагаем суб-протокол на основе EncryCore, который позволяет выстроить 
...
### Публикация образовательной программы
...
### Заключение договора об оказании образовательных услуг при помощи смарт-контракта EncryScript
...
### Потребление образовательной услуги студентом (Происходит вне рамок протокола)
### Выдача свидетельства о прохождениии студентом образовательной программы (aka диплома)
...
### Отзыв студентом оплаты за обучение в связи с тем, что ВУЗ не оказал образовательные услуги
